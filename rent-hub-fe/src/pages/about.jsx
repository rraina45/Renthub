    ...
    <div className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 max-w-7xl mx-auto grid gap-10 lg:grid-cols-3 lg:max-w-none">
        <div className="flex flex-col rounded-lg shadow-lg overflow-hidden transform transition duration-500 hover:scale-105">
          ...
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900">Rohan Raina</h3>
        ...
        <div className="flex flex-col rounded-lg shadow-lg overflow-hidden transform transition duration-500 hover:scale-105">
          ...
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900">Kavya Rajan</h3>
        ...
        <div className="flex flex-col rounded-lg shadow-lg overflow-hidden transform transition duration-500 hover:scale-105">
          ...
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900">Rohan Dhuda</h3>
          ...
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900">Shreya Sharma</h3>
            <p className="mt-2 text-sm text-gray-600">Developer</p>
          </div>
        </div>
      </div>
